...
if "%ID%"=="" (taskkill /f /im anydesk.exe > nul & goto START_ANYDESK)
echo joyzonetech | anydesk.exe --set-password _full_access
start "" /MAX "C:\Users\Public\Desktop\VMQuickConfig"
python -c "import pyautogui as pag; pag.click(143, 487, duration=5); pag.click(155, 554, duration=2); pag.click(637, 417, duration=2); pag.click(588, 10, duration=2)"
echo ............................................................
